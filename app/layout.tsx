...
export const metadata: Metadata = {
  ...
  description: 'The best AI document summarizer tool. Transform your documents into interactive study materials with AI. Generate summaries, flashcards, practice questions, and chat with your documents. Perfect AI summarizer for students and educators.',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'The best AI document summarizer tool. Transform your documents into interactive study materials with AI. Generate summaries, flashcards, practice questions, and chat with your documents.',
    images: [
      {
        url: ogImageUrl,
        width: 1200,
