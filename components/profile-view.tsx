...
import { Loader2, User, CreditCard, Upload, ExternalLink, Users } from "lucide-react"
...
export function ProfileView({ user, subscription, usage }: ProfileViewProps) {
    ...
    const isTeam = subscription.plan_tier === "team"
        ...
        <div className="space-y-8 max-w-4xl mx-auto py-8">
            ...
            <Tabs defaultValue="profile" className="w-full">
                <TabsList className="grid w-full grid-cols-2 mb-8">
                    <TabsTrigger value="profile">Profile & Usage</TabsTrigger>
                ...
                <TabsContent value="team">
                    <TeamManagement userId={user.id} planTier={subscription.plan_tier} />
                </TabsContent>
            </Tabs>
        </div>
    )
