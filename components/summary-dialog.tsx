...
export function SummaryDialog({ open, onOpenChange, documentId, selectedText, onSuccess }: SummaryDialogProps) {
      ...
      <DialogContent className="max-w-[calc(100vw-2rem)] sm:max-w-lg md:max-w-2xl">
        ...
        <div className="space-y-4">
          ...
          {(completion || isLoading) && (
            <div>
              <Label>Summary</Label>
              <div className="mt-2 p-4 bg-muted rounded-lg text-sm max-h-96 overflow-y-auto prose prose-sm dark:prose-invert max-w-none">
